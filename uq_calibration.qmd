...
Do the $1\sigma$ ($\approx$68%) prediction intervals contain 68% of held-out observations, and the $2\sigma$ ($\approx$95%) intervals contain 95%? Coverage above the nominal level indicates underconfident (conservative) intervals and coverage below indicates overconfidence. Plot observed coverage against nominal coverage for a range of probability levels (e.g., 10% through 90%). A well-calibrated model lies on the diagonal. This generalises the coverage check to all levels simultaneously and is the regression analogue of the classification reliability diagram [@kuleshov2018accurate].
